    ...
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-black via-blue-950 to-purple-950">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          >
            They call me
            <span className="bg-gradient-to-r from-blue-400 to-purple-500 text-transparent bg-clip-text"> YOUNES</span>
          </motion.h1>
          ...
          >
            Bringing stories to life through voice-over artistry and cinematic video editing
          </motion.p>
